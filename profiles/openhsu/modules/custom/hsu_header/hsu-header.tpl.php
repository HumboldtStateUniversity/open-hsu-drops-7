      ...
      <div class="hsu-header-col-6 hsu-header-mark">
        <p>
          <a href="http://humboldt.edu">
            <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1420.2 97.21">   <g data-name="Layer 2">     <g data-name="Layer 1">       <g data-name="calpoly-humboldt-mark">         <title id="humboldtTitle">Cal Poly Humboldt</title>
