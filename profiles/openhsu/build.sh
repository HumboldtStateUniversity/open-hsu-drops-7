...
if [ $SELECTION = "1" ]; then
  ...
  echo "Building Open HSU distribution..."
  DRUSH_OPTS='--no-cache --no-gitinfofile --contrib-destination=profiles/openhsu'
...
ln -s /opt/files/openhsu "$DRUPAL/sites/default/files"
